...
namespace Registro
{
    ...
    public class RegistroLog<T> where T : Person
    {
        private List<T> personas;

        public List<T> Personas { get => personas; }
        ...
        public void LogPersona(T persona)
        {
            this.personas.Add(persona);
        }

        public void LogProvider<U>() where U : Provider
        {
